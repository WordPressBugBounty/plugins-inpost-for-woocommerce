...
<div class="wrap">
    ...
    <form method="get">
        ...
        <div style="float:left;">
            <p>
                <a id="easypack_create_posting_confirmation" class="button-primary" href=""><?php _e( 'Create posting confirmation', 'woocommerce-inpost' ); ?></a>
            </p>
        </div>
        <div style="float:left;">
...
<script type="text/javascript">
    ...
    jQuery('#easypack_create_posting_confirmation').click(function () {
        ...
        if (count_parcels === 0) {
            alert('<?php _e( 'No parcels selected to create manifest.', 'woocommerce-inpost' ) ?>');
