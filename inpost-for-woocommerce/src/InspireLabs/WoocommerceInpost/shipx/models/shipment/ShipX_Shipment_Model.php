...
class ShipX_Shipment_Model {
	...
	/**
	 * @desc Alcohol courier shipment
	 */
	const SERVICE_INPOST_COURIER_ESMARTMIX = 'inpost_courier_alcohol';
	...
	/**
	 * Get commercial product identifier
	 *
	 * @return string
	 */
	public function getCommercialProductIdentifier(): string {
		return $this->commercial_product_identifier;
	}

	/**
	 * Set commercial product identifier
	 *
	 * @param string $commercial_product_identifier $commercial_product_identifier.
	 */
