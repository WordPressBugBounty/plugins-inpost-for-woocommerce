...
if ( ! class_exists( 'EasyPack_Shipping_Method_Courier_Palette' ) ) {
	class EasyPack_Shipping_Method_Courier_Palette extends EasyPack_Shippng_Parcel_Machines {
		...
		public function __construct( $instance_id = 0 ) {
			...
			$this->method_title = __( 'InPost Courier Palette', 'inpost-for-woocommerce' );
			$this->init();
		}
