...
if ( ! class_exists( 'EasyPack_Shipping_Method_Courier_LSE_COD' ) ) {
	class EasyPack_Shipping_Method_Courier_LSE_COD extends EasyPack_Shippng_Parcel_Machines {
		...
		public function __construct( $instance_id = 0 ) {
			...
			$this->method_title = __( 'InPost Courier Local Super Express COD', 'inpost-for-woocommerce' );
			$this->init();
		}
