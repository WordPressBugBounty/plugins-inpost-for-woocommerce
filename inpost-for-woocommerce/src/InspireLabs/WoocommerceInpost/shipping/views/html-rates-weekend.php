...
<tr valign="top">
    ...
    <td class="forminp">
        <table id="<?php echo esc_attr( $field ); ?>" class="easypack_rates wc_input_table sortable widefat">
            ...
            <tr>
                <th class="sort">&nbsp;</th>
                <th><?php esc_html_e( 'Min', 'inpost-for-woocommerce' ); ?></th>
                <th><?php esc_html_e( 'Max', 'inpost-for-woocommerce' ); ?></th>
                <th><?php esc_html_e( 'Cost', 'inpost-for-woocommerce' ); ?></th>
                <th><?php esc_html_e( 'Action', 'inpost-for-woocommerce' ); ?></th>
            </tr>
            </thead>
            <tbody>
            <?php $count = 0; ?>
