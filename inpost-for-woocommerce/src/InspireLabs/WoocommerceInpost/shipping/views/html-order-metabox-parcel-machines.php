...
<p><span style="font-weight: bold"><?php esc_html_e( 'Status:', 'inpost-for-woocommerce' ); ?> </span>
	...
	<span class="easypack_status" title="<?php echo esc_attr( $status_desc ); ?>"><?php echo esc_html( $status_title ); ?>
...
<ul id="easypack_parcels" style="list-style: none">
	...
	<?php foreach ( $parcels as $parcel ) : ?>
		<li>
			<?php if ( 'new' === $status || $additional_package ) : ?>
				<?php
				$params = array(
					'type'        => 'select',
				...
				?>
				<?php if ( 'new' === $status && ! $first_parcel ) : ?>
