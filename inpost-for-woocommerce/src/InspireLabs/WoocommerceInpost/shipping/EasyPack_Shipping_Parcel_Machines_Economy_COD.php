...
if ( ! class_exists( 'EasyPack_Shipping_Parcel_Machines_Economy_COD' ) ) {
    class EasyPack_Shipping_Parcel_Machines_Economy_COD
        ...
        public function __construct( $instance_id = 0 ) {
            ...
            $this->method_title = __( 'InPost Locker Economy COD', 'woocommerce-inpost' );
            $this->init();
        ...
        public function init_form_fields() {
            ...
            $settings = [
                ...
                'title'              => [
                    ...
                    'type'              => 'text',
                    'default'           => __( 'InPost Locker Economy COD', 'woocommerce-inpost' ),
