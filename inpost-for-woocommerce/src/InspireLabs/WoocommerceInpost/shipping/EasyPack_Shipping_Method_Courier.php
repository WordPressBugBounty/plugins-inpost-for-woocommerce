...
if ( ! class_exists( 'EasyPack_Shipping_Method_Courier' ) ) {
	class EasyPack_Shipping_Method_Courier
		...
		public static function ajax_create_package( $courier = false ) {
            ...
            try {
                ...
                //\wc_get_logger()->debug( 'Inpost Courier RESPONSE: ', array( 'source' => 'inpost-courier-log' ) );
                //\wc_get_logger()->debug( print_r( $response, true), array( 'source' => 'inpost-courier-log' ) );
