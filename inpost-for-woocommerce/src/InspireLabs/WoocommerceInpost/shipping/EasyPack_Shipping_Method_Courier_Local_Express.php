...
if ( ! class_exists( 'EasyPack_Shipping_Method_Courier_Local_Express' ) ) {
	class EasyPack_Shipping_Method_Courier_Local_Express extends EasyPack_Shippng_Parcel_Machines {
		...
		public function __construct( $instance_id = 0 ) {
			...
			$this->method_title = __( 'InPost Courier Local Express', 'inpost-for-woocommerce' );
			$this->init();
		}
