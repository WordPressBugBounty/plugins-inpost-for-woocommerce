...
if ( ! class_exists( 'EasyPack_Shipping_Method_Courier_Palette_COD' ) ) {
	class EasyPack_Shipping_Method_Courier_Palette_COD extends EasyPack_Shippng_Parcel_Machines {

		const WP_AJAX_ACTION_CREATE = 'courier_palette_cod_create_package';
		...
		public function __construct( $instance_id = 0 ) {
			...
			$this->method_title = __( 'InPost Courier Palette COD', 'inpost-for-woocommerce' );
			$this->init();
		}
		...
		public static function order_metabox_content(
			...
			$send_methods         = array();
			$selected_service
			= $shipment_service->get_customer_service_name_by_id( self::SERVICE_ID );
			include 'views/html-order-metabox-courier-cod.php';
