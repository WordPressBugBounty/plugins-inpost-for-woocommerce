...
if ( ! class_exists( 'EasyPack_Shipping_Method_Courier_Local_Standard_COD' ) ) {
	class EasyPack_Shipping_Method_Courier_Local_Standard_COD
		...
		public function __construct( $instance_id = 0 ) {
			...
			$this->method_title = __( 'InPost Courier Local Standard COD', 'woocommerce-inpost' );
			$this->init();
		}
		...
		public function init_form_fields() {
			...
			$settings = [
				...
				'flat_rate'          => [
					...
					'type'    => 'checkbox',
					'label'   => __( 'Set a flat-rate shipping fee for the entire order.',
                        'woocommerce-inpost' ),
					'class'   => 'easypack_flat_rate',
					'default' => 'yes',
				],
				'cost_per_order'     => [
					'title'             => __( 'Cost per order',
                        'woocommerce-inpost' ),
					'type'              => 'number',
					'custom_attributes' => [ 'step' => 'any', 'min' => '0' ],
