...
= 1.9.6 =
* Fix: selection of orders for bulk actions

= 1.9.5 =
* Fix: fix order meta for non-locker methods
* Fix: Courier pickup request
...
* Fix: calculation of product dimensions in mm/kg depending on Woo measurements settings

= 1.9.2 =
* Fix: webhook status update for HPOS
* Fix: messages during Bulk creating and getting labels

= 1.9.1 =
* Fix: access control for update of "_parcel_machine_id" in method "update_locker_from_typ_page_callback"

= 1.9.0 =
* Fix: metabox view in order details

= 1.8.9 =
* Feat: change shipping method for even 1st shipment creation
* Feat: new setting, add InPost shipment creation metabox to any order
* Fix: PHP warnings
* Fix: PWW mode

= 1.8.8 =
* Fix: webhook initial  status
* Fix: product table Polylang compatibility
