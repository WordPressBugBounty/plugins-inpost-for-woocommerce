!function () {
    ...
    function r(t) {
        let {handleLockerChange: o, inpostLocker: l} = t;
        const [c, n] = (0, e.useState)(null);
        return (0, e.useEffect)((() => {
            const e = l, t = e;
            n(t)
        }), [l]), (0, e.createElement)("div", {className: "inpost-parcel-locker-wrap"}, (0, e.createElement)("input", {
            value: l,
            type: "text",
    ...
    !!(0, o.select)("core/editor") && (0, t.registerBlockType)(i, {
        ...
        metadata: a, component: t => {
            ...
            return (0, e.useEffect)((() => {
                i("inpost", "inpost-parcel-locker-id", a)
